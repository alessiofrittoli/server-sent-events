# Contributing to Server-Sent Events ✅

We’re excited that you’re interested in contributing to Server-Sent Events! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/server-sent-events/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/server-sent-events).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/server-sent-events.git
```
...
Thank you for helping improve Server-Sent Events! 🎉